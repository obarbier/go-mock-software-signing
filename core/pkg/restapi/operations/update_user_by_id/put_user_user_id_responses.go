...
// PutUserUserIDInternalServerErrorCode is the HTTP code returned for type PutUserUserIDInternalServerError
const PutUserUserIDInternalServerErrorCode int = 500

/*
PutUserUserIDInternalServerError server error

swagger:response putUserUserIdInternalServerError
*/
type PutUserUserIDInternalServerError struct {
...
// NewPutUserUserIDInternalServerError creates PutUserUserIDInternalServerError with default headers values
func NewPutUserUserIDInternalServerError() *PutUserUserIDInternalServerError {

	return &PutUserUserIDInternalServerError{}
}

// WithPayload adds the payload to the put user user Id internal server error response
func (o *PutUserUserIDInternalServerError) WithPayload(payload *models.Error) *PutUserUserIDInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the put user user Id internal server error response
func (o *PutUserUserIDInternalServerError) SetPayload(payload *models.Error) {
	o.Payload = payload
}

// WriteResponse to the client
func (o *PutUserUserIDInternalServerError) WriteResponse(rw http.ResponseWriter, producer runtime.Producer) {
